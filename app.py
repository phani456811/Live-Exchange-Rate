    ...
    try:
        ...
        if live_rates:
            ...
            if countries_response.status_code == 200:
                ...
                for country in countries_data[:40]:  # Limit to 40 countries
        ...
        raise Exception("Could not fetch live data")
    ...
    try:
        ...
        if live_rates and to_currency in live_rates:
            ...
            if reverse_rates and from_currency in reverse_rates:
                ...
                # Ultimate fallback to demo rates
                demo_rates = {
                    'USD': {'EUR': 0.92, 'GBP': 0.79, 'JPY': 148.50, 'INR': 83.25, 'CAD': 1.35, 'AUD': 1.52},
                    'EUR': {'USD': 1.09, 'GBP': 0.86, 'JPY': 161.50, 'INR': 90.50},
                    'GBP': {'USD': 1.27, 'EUR': 1.16, 'JPY': 188.00, 'INR': 105.25},
